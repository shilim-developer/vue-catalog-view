...
// ../../node_modules/.pnpm/vue@3.5.14_typescript@5.8.3/node_modules/vue/dist/vue.cjs.js
var require_vue_cjs = __commonJS({
  "../../node_modules/.pnpm/vue@3.5.14_typescript@5.8.3/node_modules/vue/dist/vue.cjs.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/vue@3.5.14_typescript@5.8.3/node_modules/vue/index.js
var require_vue = __commonJS({
  "../../node_modules/.pnpm/vue@3.5.14_typescript@5.8.3/node_modules/vue/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
var require_vue_test_utils_cjs = __commonJS({
  "../../node_modules/.pnpm/@vue+test-utils@2.4.6/node_modules/@vue/test-utils/dist/vue-test-utils.cjs.js"(exports) {
    "use strict";
    var Vue = require_vue();
    var compilerDom = (init_compiler_dom_esm_bundler(), __toCommonJS(compiler_dom_esm_bundler_exports));
    var serverRenderer = (init_server_renderer_esm_bundler(), __toCommonJS(server_renderer_esm_bundler_exports));
    function _interopNamespaceDefault(e) {
      var n = /* @__PURE__ */ Object.create(null);
      if (e) {
    ...
    function processSlot(source, Vue2) {
      if (source === void 0) {
        source = "";
      }
      if (Vue2 === void 0) {
      ...
      var renderFn = createRenderFunction(Vue2);
      return function(ctx) {
        if (ctx === void 0) {
          ctx = {};
        }
    ...
    var DEFAULT_STUBS = {
      ...
      transition: function(type) {
        return type === Vue.Transition || type === Vue.BaseTransition;
      },
      "transition-group": function(type) {
        return type === Vue.TransitionGroup;
      }
    };
    ...
    function createInstance(inputComponent, options2) {
      ...
      if (isFunctionalComponent(originalComponent) || isLegacyFunctionalComponent(originalComponent)) {
        component = Vue.defineComponent(__assign({ compatConfig: {
          ...
          return function() {
            return Vue.h(originalComponent, __assign(__assign({}, props2), attrs), slots2);
          };
        } }, instanceOptions));
    ...
    function mount2(inputComponent, options2) {
    ...
    var shallowMount = function(component, options2) {
      return mount2(component, __assign(__assign({}, options2), { shallow: true }));
    };
    ...
    var RouterLinkStub = Vue.defineComponent({
      ...
      render: function() {
        ...
        return this.custom ? children : Vue.h("a", void 0, children);
      }
    });
...
// ../../node_modules/.pnpm/vitest-browser-vue@0.2.0_@vitest+browser@3.1.3_vitest@3.1.3_vue@3.5.14_typescript@5.8.3_/node_modules/vitest-browser-vue/dist/chunk-ELIMMUCX.js
var import_test_utils = __toESM(require_vue_test_utils_cjs(), 1);
var import_test_utils2 = __toESM(require_vue_test_utils_cjs(), 1);
...
function render(Component, {
  ...
  const wrapper = (0, import_test_utils.mount)(Component, {
    ...mountOptions,
    attachTo: container
  });
...
function cleanup() {
  mountedWrappers.forEach((wrapper) => {
    var _a, _b;
    if (((_b = (_a = wrapper.element) == null ? void 0 : _a.parentNode) == null ? void 0 : _b.parentNode) === document.body) {
...
// ../../node_modules/.pnpm/vitest-browser-vue@0.2.0_@vitest+browser@3.1.3_vitest@3.1.3_vue@3.5.14_typescript@5.8.3_/node_modules/vitest-browser-vue/dist/index.js
...
var export_config = import_test_utils2.config;
export {
  cleanup,
...
@vue/test-utils/dist/vue-test-utils.cjs.js:
  (*!
   * isElementVisible
   ...
   *)
*/
//# sourceMappingURL=vitest-browser-vue.js.map
