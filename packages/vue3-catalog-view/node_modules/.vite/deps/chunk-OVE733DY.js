...
// ../../node_modules/.pnpm/@babel+parser@7.27.2/node_modules/@babel/parser/lib/index.js
var require_lib = __commonJS({
  "../../node_modules/.pnpm/@babel+parser@7.27.2/node_modules/@babel/parser/lib/index.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/@vue+compiler-core@3.5.14/node_modules/@vue/compiler-core/dist/compiler-core.cjs.js
var require_compiler_core_cjs = __commonJS({
  "../../node_modules/.pnpm/@vue+compiler-core@3.5.14/node_modules/@vue/compiler-core/dist/compiler-core.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function createSimpleExpression2(content, isStatic = false, loc = locStub, constType = 0) {
      return {
        type: 4,
        loc,
        content,
    ...
    function createCompoundExpression2(children, loc = locStub) {
      return {
        type: 8,
        loc,
        children
    ...
    function createCallExpression2(callee, args = [], loc = locStub) {
      return {
        type: 14,
        loc,
        callee,
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
    ...
    function findDir2(node, name, allowEmpty = false) {
    ...
    function findProp2(node, name, dynamicOnly = false, allowEmpty = false) {
      for (let i = 0; i < node.props.length; i++) {
        const p = node.props[i];
        if (p.type === 6) {
    ...
    function hasDynamicKeyVBind2(node) {
      ...
      if (props == null || shared.isString(props)) {
        ...
        if (!shared.isString(first) && first.type === 15) {
          ...
          if (props.callee === TO_HANDLERS) {
            propsWithInjection = createCallExpression2(context.helper(MERGE_PROPS), [
    ...
    var tokenizer = new Tokenizer(stack2, {
      ...
      ondirname(start, end) {
        ...
        if (inVPre || name === "") {
          ...
          currentProp = {
            ...
            exp: void 0,
            arg: void 0,
            modifiers: raw === "." ? [createSimpleExpression2("prop")] : [],
            loc: getLoc(start)
          };
          if (name === "pre") {
      ...
      ondirmodifier(start, end) {
        ...
        if (inVPre) {
          ...
          const exp = createSimpleExpression2(mod, true, getLoc(start, end));
    ...
    function onCloseTag(el, end, isImplied = false) {
      ...
      }
      {
        ...
        if (inlineTemplateProp && checkCompatEnabled2(
          "COMPILER_INLINE_TEMPLATE",
          currentOptions,
    ...
    function isComponent({ tag, props }) {
      ...
      for (let i = 0; i < props.length; i++) {
        ...
        if (p.type === 6) {
          ...
          p.name === "bind" && isStaticArgOf2(p.arg, "is") && checkCompatEnabled2(
            "COMPILER_IS_ON_ELEMENT",
            currentOptions,
            p.loc
          )
    ...
    function createExp(content, isStatic = false, loc, constType = 0, parseMode = 0) {
      const exp = createSimpleExpression2(content, isStatic, loc, constType);
    ...
    function emitError(code, index, message) {
      currentOptions.onError(
        createCompilerError2(code, getLoc(index, index), void 0, message)
      );
    }
    function reset() {
      tokenizer.reset();
    ...
    function baseParse2(input, options) {
      reset();
      currentInput = input;
    ...
    function walk(node, parent, context, doNotHoistNode = false, inFor = false) {
      ...
      if (toCache.length === children.length && node.type === 1) {
        if (node.tagType === 0 && node.codegenNode && node.codegenNode.type === 13 && shared.isArray(node.codegenNode.children)) {
          ...
          const slotName = findDir2(node, "slot", true);
      ...
      if (slotCacheKeys.length && node.type === 1 && node.tagType === 1 && node.codegenNode && node.codegenNode.type === 13 && node.codegenNode.children && !shared.isArray(node.codegenNode.children) && node.codegenNode.children.type === 15) {
        node.codegenNode.children.properties.push(
          createObjectProperty2(
            `__`,
            createSimpleExpression2(JSON.stringify(slotCacheKeys), false)
          )
        );
      }
    ...
    function getConstantType2(node, context) {
      ...
      switch (node.type) {
        case 1:
          ...
          if (codegenNode.patchFlag === void 0) {
            ...
            for (let i = 0; i < node.children.length; i++) {
              const childType = getConstantType2(node.children[i], context);
              if (childType === 0) {
                constantCache.set(node, 0);
                return 0;
              }
        ...
        case 5:
        case 12:
          return getConstantType2(node.content, context);
        case 4:
    ...
    function createTransformContext(root, {
      ...
      const context = {
        ...
        hoist(exp) {
          if (shared.isString(exp)) exp = createSimpleExpression2(exp);
          context.hoists.push(exp);
          const identifier = createSimpleExpression2(
          ...
          if (isConst(type) || type === "setup-reactive-const" || localVars[raw]) {
            ...
            if (isAssignmentLVal) {
              ...
              const rExpString = stringifyExpression(
                processExpression(
                  createSimpleExpression2(rExp, false),
                  context,
                  false,
                  false,
                  knownIds
...
` : ``} ? ${prefix}${raw}.value${postfix} : ${prefix}${raw}${postfix}`;
      ...
      let ret;
      if (children.length) {
        ret = createCompoundExpression2(children, node.loc);
        ret.ast = ast;
      } else {
        ret = node;
        ret.constType = 3;
    ...
    function processIf(node, dir, context, processCodegen) {
      if (dir.name !== "else" && (!dir.exp || !dir.exp.content.trim())) {
        ...
        context.onError(
          createCompilerError2(28, dir.loc)
        );
        ...
        while (i-- >= -1) {
          ...
          if (sibling && sibling.type === 9) {
            if (dir.name === "else-if" && sibling.branches[sibling.branches.length - 1].condition === void 0) {
              context.onError(
                createCompilerError2(30, node.loc)
              );
            }
            context.removeNode();
            const branch = createIfBranch(node, dir);
    ...
    function createIfBranch(node, dir) {
      ...
      return {
        ...
        children: isTemplateIf && !findDir2(node, "for") ? node.children : [node],
        userKey: findProp2(node, `key`),
        isTemplateIf
      };
    }
    function createCodegenNodeForBranch(branch, keyIndex, context) {
      if (branch.condition) {
        return createConditionalExpression(
          ...
          createCallExpression2(context.helper(CREATE_COMMENT), [
            '"v-if"',
            "true"
          ])
        );
    ...
    function createChildrenCodegenNode(branch, keyIndex, context) {
      const { helper } = context;
      const keyProperty = createObjectProperty2(
        `key`,
        createSimpleExpression2(
          `${keyIndex}`,
          false,
    ...
    var transformBind = (dir, _node, context) => {
      ...
      if (exp && exp.type === 4 && !exp.content.trim()) {
        {
          context.onError(
            createCompilerError2(34, loc)
          );
          return {
            props: [
              createObjectProperty2(arg, createSimpleExpression2("", true, loc))
            ]
          };
        }
      }
    ...
    var transformBindShorthand = (dir, context) => {
      ...
      dir.exp = createSimpleExpression2(propName, false, arg.loc);
      {
        dir.exp = processExpression(dir.exp, context);
      }
    };
    ...
    var transformFor = createStructuralDirectiveTransform(
      ...
      (node, dir, context) => {
        ...
        return processFor(node, dir, context, (forNode) => {
          const renderExp = createCallExpression2(helper(RENDER_LIST), [
            forNode.source
          ]);
          const isTemplate = isTemplateNode(node);
          const memo = findDir2(node, "memo");
          const keyProp = findProp2(node, `key`, false, true);
          const isDirKey = keyProp && keyProp.type === 7;
          if (isDirKey && !keyProp.exp) {
            transformBindShorthand(keyProp, context);
          }
          let keyExp = keyProp && (keyProp.type === 6 ? keyProp.value ? createSimpleExpression2(keyProp.value.content, true) : void 0 : keyProp.exp);
          ...
          const keyProperty = keyProp && keyExp ? createObjectProperty2(`key`, keyExp) : null;
          if (isTemplate) {
            if (memo) {
          ...
          return () => {
            ...
            if (memo) {
              ...
              renderExp.arguments.push(
                loop,
                createSimpleExpression2(`_cache`),
                createSimpleExpression2(String(context.cached.length))
              );
    ...
    function processFor(node, dir, context, processCodegen) {
      if (!dir.exp) {
        context.onError(
          createCompilerError2(31, dir.loc)
        );
        return;
      }
      ...
      if (!parseResult) {
        context.onError(
          createCompilerError2(32, dir.loc)
        );
        return;
      }
    ...
    var defaultFallback = createSimpleExpression2(`undefined`, false);
    var trackSlotScopes = (node, context) => {
      if (node.type === 1 && (node.tagType === 1 || node.tagType === 3)) {
        const vSlot = findDir2(node, "slot");
        if (vSlot) {
    ...
    var trackVForSlotScopes = (node, context) => {
      let vFor;
      if (isTemplateNode(node) && node.props.some(isVSlot) && (vFor = findDir2(node, "for"))) {
    ...
    function buildSlots(node, context, buildSlotFn = buildClientSlotFn) {
      ...
      const onComponentSlot = findDir2(node, "slot", true);
      if (onComponentSlot) {
        ...
        slotsProperties.push(
          createObjectProperty2(
            arg || createSimpleExpression2("default", true),
      ...
      for (let i = 0; i < children.length; i++) {
        ...
        let slotDir;
        if (!isTemplateNode(slotElement) || !(slotDir = findDir2(slotElement, "slot", true))) {
        ...
        if (onComponentSlot) {
          context.onError(
            createCompilerError2(37, slotDir.loc)
          );
          break;
        }
        ...
        const {
          arg: slotName = createSimpleExpression2(`default`, true),
          exp: slotProps,
          loc: dirLoc
        } = slotDir;
        let staticSlotName;
        ...
        const vFor = findDir2(slotElement, "for");
        ...
        if (vIf = findDir2(slotElement, "if")) {
          ...
          if (prev && isTemplateNode(prev) && findDir2(prev, /^(else-)?if$/)) {
            ...
            context.onError(
              createCompilerError2(30, vElse.loc)
            );
          }
        } else if (vFor) {
          hasDynamicSlots = true;
          ...
          if (parseResult) {
            finalizeForParseResult(parseResult, context);
            dynamicSlots.push(
              createCallExpression2(context.helper(RENDER_LIST), [
                parseResult.source,
                createFunctionExpression(
      ...
      if (dynamicSlots.length) {
        slots = createCallExpression2(context.helper(CREATE_SLOTS), [
          slots,
    ...
    function buildDynamicSlot(name, fn, index) {
      ...
      if (index != null) {
        props.push(
          createObjectProperty2(`key`, createSimpleExpression2(String(index), true))
        );
      }
    ...
    function resolveComponentType(node, context, ssr = false) {
      ...
      if (isProp) {
        if (isExplicitDynamic || isCompatEnabled(
          ...
          let exp;
          if (isProp.type === 6) {
            exp = isProp.value && createSimpleExpression2(isProp.value.content, true);
          } else {
            exp = isProp.exp;
            if (!exp) {
              exp = createSimpleExpression2(`is`, false, isProp.arg.loc);
              {
          ...
          if (exp) {
            return createCallExpression2(context.helper(RESOLVE_DYNAMIC_COMPONENT), [
              exp
            ]);
          }
    ...
    function buildProps(node, context, props = node.props, isComponent2, isDynamicComponent, ssr = false) {
      ...
      const pushRefVForMarker = () => {
        if (context.scopes.vFor > 0) {
          properties.push(
            createObjectProperty2(
              createSimpleExpression2("ref_for", true),
              createSimpleExpression2("true")
            )
          );
        }
      };
      ...
      for (let i = 0; i < props.length; i++) {
        ...
        if (prop.type === 6) {
          ...
          if (name === "ref") {
            ...
            if (value && context.inline) {
              ...
              if (binding === "setup-let" || binding === "setup-ref" || binding === "setup-maybe-ref") {
                ...
                properties.push(
                  createObjectProperty2(
                    createSimpleExpression2("ref_key", true),
                    createSimpleExpression2(value.content, true, value.loc)
                  )
                );
              }
            }
          ...
          properties.push(
            createObjectProperty2(
              createSimpleExpression2(name, true, nameLoc),
              createSimpleExpression2(
                value ? value.content : "",
                isStatic,
                value ? value.loc : loc
          ...
          if (name === "is" || isVBind && isStaticArgOf2(arg, "is") && (isComponentTag(tag) || isCompatEnabled(
            "COMPILER_IS_ON_ELEMENT",
            context
          ))) {
            continue;
          ...
          if (
            ...
            isVBind && isStaticArgOf2(arg, "key") || // inline before-update hooks need to force block so that it is invoked
            // before children
            isVOn && hasChildren && isStaticArgOf2(arg, "vue:before-update")
          ) {
            shouldUseBlock = true;
          }
          if (isVBind && isStaticArgOf2(arg, "ref")) {
            pushRefVForMarker();
          }
      ...
      if (mergeArgs.length) {
        ...
        if (mergeArgs.length > 1) {
          propsExpression = createCallExpression2(
        ...
        switch (propsExpression.type) {
          case 15:
            ...
            if (!hasDynamicKey) {
              if (classProp && !isStaticExp2(classProp.value)) {
                classProp.value = createCallExpression2(
              ...
              styleProp.value.type === 17)) {
                styleProp.value = createCallExpression2(
          ...
          default:
            propsExpression = createCallExpression2(
              context.helper(NORMALIZE_PROPS),
              [
                createCallExpression2(context.helper(GUARD_REACTIVE_PROPS), [
                  propsExpression
                ])
              ]
            );
      ...
      if (Object.keys(dir.modifiers).length) {
        ...
        dirArgs.push(
          createObjectExpression(
            dir.modifiers.map(
              (modifier) => createObjectProperty2(modifier, trueExpression)
            ),
            loc
          )
        );
    ...
    var transformSlotOutlet = (node, context) => {
      if (isSlotOutlet(node)) {
        ...
        node.codegenNode = createCallExpression2(
        ...
        if (p.type === 6) {
          ...
          if (p.name === "bind" && isStaticArgOf2(p.arg, "name")) {
            if (p.exp) {
              ...
              slotName = p.exp = createSimpleExpression2(name, false, p.arg.loc);
              {
    ...
    var transformOn2 = (dir, node, context, augmentor) => {
      ...
      if (arg.type === 4) {
        if (arg.isStatic) {
          ...
          if (rawName.startsWith("vnode")) {
            context.onError(createCompilerError2(51, arg.loc));
          }
          ...
          eventName = createSimpleExpression2(eventString, true, arg.loc);
        } else {
...
` : ``}(...args)`} => ${hasMultipleStatements ? `{` : `(`}`,
      ...
      let ret = {
        props: [
          createObjectProperty2(
            eventName,
            exp || createSimpleExpression2(`() => {}`, false, loc)
          )
        ]
      };
      if (augmentor) {
          ...
          for (let i = 0; i < children.length; i++) {
            ...
            if (isText$1(child)) {
              ...
              for (let j = i + 1; j < children.length; j++) {
                ...
                if (isText$1(next)) {
                  if (!currentContainer) {
                    currentContainer = children[i] = createCompoundExpression2(
                      [child],
                      child.loc
                    );
                  }
          ...
          for (let i = 0; i < children.length; i++) {
            ...
            if (isText$1(child) || child.type === 8) {
              ...
              children[i] = {
                ...
                content: child,
                loc: child.loc,
                codegenNode: createCallExpression2(
    ...
    var transformOnce = (node, context) => {
      if (node.type === 1 && findDir2(node, "once", true)) {
    ...
    var transformModel2 = (dir, node, context) => {
      ...
      if (!exp) {
        context.onError(
          createCompilerError2(41, dir.loc)
        );
      ...
      if (bindingType === "props" || bindingType === "props-aliased") {
        context.onError(createCompilerError2(44, exp.loc));
        return createTransformProps();
      }
      const maybeRef = context.inline && (bindingType === "setup-let" || bindingType === "setup-ref" || bindingType === "setup-maybe-ref");
      if (!expString.trim() || !isMemberExpression(exp, context) && !maybeRef) {
        context.onError(
          createCompilerError2(42, exp.loc)
        );
        return createTransformProps();
      }
      if (context.prefixIdentifiers && isSimpleIdentifier(expString) && context.identifiers[expString]) {
        context.onError(
          createCompilerError2(43, exp.loc)
        );
        return createTransformProps();
      }
      const propName = arg ? arg : createSimpleExpression2("modelValue", true);
      const eventName = arg ? isStaticExp2(arg) ? `onUpdate:${shared.camelize(arg.content)}` : createCompoundExpression2(['"onUpdate:" + ', arg]) : `onUpdate:modelValue`;
      let assignmentExp;
      ...
      if (node.type === 1) {
        ...
        return () => {
          ...
          if (codegenNode && codegenNode.type === 13) {
            ...
            node.codegenNode = createCallExpression2(context.helper(WITH_MEMO), [
              dir.exp,
    ...
    function baseCompile2(source, options = {}) {
      ...
      if (options.scopeId && !isModuleMode) {
        onError(createCompilerError2(50));
      }
      const resolvedOptions = shared.extend({}, options, {
        prefixIdentifiers
      });
      const ast = shared.isString(source) ? baseParse2(source, resolvedOptions) : source;
    ...
    exports.TO_DISPLAY_STRING = TO_DISPLAY_STRING2;
    ...
    exports.checkCompatEnabled = checkCompatEnabled2;
    exports.convertToBlock = convertToBlock;
    exports.createArrayExpression = createArrayExpression;
    exports.createAssignmentExpression = createAssignmentExpression;
    exports.createBlockStatement = createBlockStatement;
    exports.createCacheExpression = createCacheExpression;
    exports.createCallExpression = createCallExpression2;
    exports.createCompilerError = createCompilerError2;
    exports.createCompoundExpression = createCompoundExpression2;
    ...
    exports.createObjectProperty = createObjectProperty2;
    exports.createReturnStatement = createReturnStatement;
    exports.createRoot = createRoot;
    exports.createSequenceExpression = createSequenceExpression;
    exports.createSimpleExpression = createSimpleExpression2;
    ...
    exports.findDir = findDir2;
    exports.findProp = findProp2;
    exports.forAliasRE = forAliasRE;
    exports.generate = generate;
    exports.getBaseTransformPreset = getBaseTransformPreset;
    exports.getConstantType = getConstantType2;
    exports.getMemoedVNodeCall = getMemoedVNodeCall;
    exports.getVNodeBlockHelper = getVNodeBlockHelper;
    exports.getVNodeHelper = getVNodeHelper;
    exports.hasDynamicKeyVBind = hasDynamicKeyVBind2;
    ...
    exports.isStaticArgOf = isStaticArgOf2;
    exports.isStaticExp = isStaticExp2;
    ...
    exports.noopDirectiveTransform = noopDirectiveTransform2;
    exports.processExpression = processExpression;
    exports.processFor = processFor;
    exports.processIf = processIf;
    exports.processSlotOutlet = processSlotOutlet;
    exports.registerRuntimeHelpers = registerRuntimeHelpers2;
    ...
    exports.transformModel = transformModel2;
    exports.transformOn = transformOn2;
...
// ../../node_modules/.pnpm/@vue+compiler-core@3.5.14/node_modules/@vue/compiler-core/index.js
var require_compiler_core = __commonJS({
  "../../node_modules/.pnpm/@vue+compiler-core@3.5.14/node_modules/@vue/compiler-core/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// ../../node_modules/.pnpm/@vue+compiler-dom@3.5.14/node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js
...
function createDOMCompilerError(code, loc) {
  return (0, import_compiler_core.createCompilerError)(
    code,
    loc,
...
function compile(src, options = {}) {
  return (0, import_compiler_core.baseCompile)(
    src,
...
var init_compiler_dom_esm_bundler = __esm({
  "../../node_modules/.pnpm/@vue+compiler-dom@3.5.14/node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js"() {
    ...
    parseInlineCSS = (cssText, loc) => {
      ...
      return (0, import_compiler_core.createSimpleExpression)(
    ...
    transformVHtml = (dir, node, context) => {
      ...
      return {
        props: [
          (0, import_compiler_core.createObjectProperty)(
            (0, import_compiler_core.createSimpleExpression)(`innerHTML`, true, loc),
            exp || (0, import_compiler_core.createSimpleExpression)("", true)
          )
        ]
      };
    };
    transformVText = (dir, node, context) => {
      ...
      return {
        props: [
          (0, import_compiler_core.createObjectProperty)(
            (0, import_compiler_core.createSimpleExpression)(`textContent`, true),
            exp ? (0, import_compiler_core.getConstantType)(exp, context) > 0 ? exp : (0, import_compiler_core.createCallExpression)(
              context.helperString(import_compiler_core.TO_DISPLAY_STRING),
              [exp],
              loc
            ) : (0, import_compiler_core.createSimpleExpression)("", true)
          )
        ]
      };
    };
    transformModel = (dir, node, context) => {
      ...
      function checkDuplicatedValue() {
        const value = (0, import_compiler_core.findDir)(node, "bind");
        if (value && (0, import_compiler_core.isStaticArgOf)(value.arg, "value")) {
          context.onError(
            createDOMCompilerError(
              60,
              value.loc
    ...
    resolveModifiers = (key, modifiers, context, loc) => {
      ...
      for (let i = 0; i < modifiers.length; i++) {
        ...
        if (modifier === "native" && (0, import_compiler_core.checkCompatEnabled)(
          "COMPILER_V_ON_NATIVE",
          context,
          loc
        )) {
    ...
    transformOn = (dir, node, context) => {
      return (0, import_compiler_core.transformOn)(dir, node, context, (baseResult) => {
        ...
        (!(0, import_compiler_core.isStaticExp)(key) || isKeyboardEvent(key.content.toLowerCase()))) {
...
// ../../node_modules/.pnpm/@vue+server-renderer@3.5.14_vue@3.5.14_typescript@5.8.3_/node_modules/@vue/server-renderer/dist/server-renderer.esm-bundler.js
...
export {
  ...
  renderToString,
  server_renderer_esm_bundler_exports,
...
@vue/server-renderer/dist/server-renderer.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-OVE733DY.js.map
